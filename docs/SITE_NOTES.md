...
- [ ] `public/screenshots/home.png` — لقطة حقيقية لإطار الهاتف (الهيرو) — حالياً fallback نظيف.
      (المستخدم أرفق `screenshot.jpg` في المحادثة لكنها ليست ملفاً في المشروع؛ يُسقطها هنا.)
